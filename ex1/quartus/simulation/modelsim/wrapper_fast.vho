...
SIGNAL \dut|adder1|sum~0_combout\ : std_logic;
SIGNAL \dut|adder2|sum~combout\ : std_logic;
SIGNAL \SW~combout\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \dut|adder2|ALT_INV_sum~combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\dut|adder2|ALT_INV_sum~combout\ <= NOT \dut|adder2|sum~combout\;
...
\dut|adder1|sum~0\ : cycloneii_lcell_comb
-- Equation(s):
...
\dut|adder2|sum\ : cycloneii_lcell_comb
-- Equation(s):
...
-- pragma translate_on
PORT MAP (
	datain => \dut|adder2|ALT_INV_sum~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
